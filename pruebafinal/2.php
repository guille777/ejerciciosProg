...
include "3.php";
	...
	echo "Hombre lunes: ".$nuevo->imprimirDato();
	echo "<hr>";
	$nuevo->subirDato($_POST["lunesm"]);
	echo "Mujer martes".$nuevo->subidoDato();
	echo "<hr>";
	...
	foreach ($_POST as $key => $value) {
	 	$nuevo->almacenarDato($value);
			...
			echo "<hr>";
			echo "media de Hombres: ".$nuevo->mediaHom1();
			echo "<hr>";
			
			echo "media de mujeres: ".$nuevo->mediaMuj();
			echo "<hr>";
			
			echo "la media de entrada es : ".$nuevo->mediaHom();
?>
<?php
/*include "3.php";
