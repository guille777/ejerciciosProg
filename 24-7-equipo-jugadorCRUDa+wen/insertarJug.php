...
<body>
	...
	if (!empty($_POST['codigo']) && !empty($_POST['nombre']) && !empty($_POST['procedencia']) && !empty($_POST['altura']) && !empty($_POST['peso']) && !empty($_POST['posicion'] && !empty($_POST['Nombre_equipo'])  )) {
		
		$jugador->insertarJugador($_POST["codigo"],$_POST["nombre"],$_POST["procedencia"],$_POST["altura"],$_POST["peso"],$_POST["posicion"],$_POST["Nombre_equipo"]);
